...
const STRINGS: Record<AppLang, Record<string, string>> = {
  en: {
    ...
    'auth.loginSubtitle': 'Login to continue to Sirius',
    'auth.registerSubtitle': 'Sign up to start messaging on Sirius',
  ...
  ru: {
    ...
    'auth.loginSubtitle': 'Войдите чтобы продолжить в Sirius',
    'auth.registerSubtitle': 'Зарегистрируйтесь чтобы начать общение',
    'auth.username': 'Имя пользователя',
    'auth.usernamePlaceholder': 'Придумайте имя',
